...
## --- Test DecompactBackstrip function with water depth and sea level
...
# Example water depth
wd = WaterDepth(3)
wd.DepthID    = ["FWWB", "SWB", "Shallow marine"]
wd.Thickness .= [1000, 600, 400]

# Example sea level
sl = SeaLevel(3)
sl.Thickness .= [1000, 600, 400]
sl.Minimum .= [-60, -60, -60]
sl.Maximum .= [60, 60, 60]

(Sₜ_test, Sμ_test, Sσ_test, subsidence_strat_depths_test) = SubsidenceChron.DecompactBackstrip(strat_test, wd, sl, nsims_test, res_test)
...
Sμ_target = [1111.797, 1106.829, 1101.743, 1096.54, 1091.218, 1085.776, 1080.212, 1074.525, 1068.714, 1062.776, 1056.71, 1050.513, 1044.185, 1037.723, 1031.123, 1024.385, 1017.505, 1010.479, 1003.306, 995.982, 988.503, 980.865, 973.065, 965.097, 956.958, 948.641, 940.142, 931.453, 922.57, 913.484, 904.188, 894.673, 884.93, 874.948, 864.717, 854.223, 843.452, 832.388, 821.014, 809.308, 797.249, 784.807, 771.953, 758.649, 744.85, 730.5, 715.533, 699.858, 683.358, 665.861, 692.212, 681.774, 671.261, 660.674, 650.01, 639.271, 628.455, 617.562, 606.592, 595.544, 584.418, 573.214, 561.93, 550.567, 539.125, 527.603, 516.001, 504.318, 492.555, 480.711, 468.786, 456.78, 444.694, 432.526, 420.278, 407.948, 395.537, 383.046, 370.474, 357.821, 332.939, 321.357, 309.586, 297.619, 285.446, 273.059, 260.446, 247.597, 234.498, 221.134, 207.492, 193.552, 179.294, 164.696, 149.731, 134.366, 118.566, 102.282, 85.457, 68.009, 49.815]
@test all(isapprox.(Sμ_target, Sμ_test, rtol=0.03))

Sσ_target = [112.322, 112.533, 112.724, 112.897, 113.05, 113.181, 113.29, 113.377, 113.439, 113.477, 113.489, 113.474, 113.432, 113.362, 113.262, 113.133, 112.973, 112.781, 112.557, 112.3, 112.008, 111.681, 111.318, 110.919, 110.482, 110.006, 109.491, 108.936, 108.341, 107.705, 107.027, 106.306, 105.544, 104.741, 103.895, 103.01, 102.086, 101.126, 100.134, 99.115, 98.077, 97.029, 95.985, 94.965, 93.996, 93.117, 92.382, 91.872, 91.713, 92.105, 96.119, 95.706, 95.304, 94.914, 94.541, 94.185, 93.852, 93.545, 93.268, 93.024, 92.821, 92.662, 92.553, 92.502, 92.515, 92.6, 92.765, 93.019, 93.372, 93.834, 94.416, 95.129, 95.986, 97.0, 98.184, 99.553, 101.123, 102.908, 104.926, 107.194, 109.285, 107.071, 104.782, 102.414, 99.965, 97.432, 94.815, 92.112, 89.322, 86.448, 83.492, 80.461, 77.368, 74.231, 71.08, 67.962, 64.948, 62.149, 59.735, 57.975, 57.309]
@test all(isapprox.(Sσ_target, Sσ_test, atol=10))
